...
<body>
	...
	<div class="container">
		...
		<div class="jumbotron">
			...
			<form:form action="${addAction}" commandName="matricula" id="frm_addmatricula">
				<legend>Información de la Matricula</legend>
				<fieldset>
					...
					<div class="form-group">
						<label class="col-form-label" for="estudiante">Estudiante</label>
						<form:input path="estudiante" readonly="true" disabled="true"
							class="form-control" />
					...
					<div class="form-group">
						...
						<form:select path="curso" class="form-control">
							<form:options items="${listCursos}"></form:options>
						</form:select>
					</div>
					<div class="form-group">
						<label class="col-form-label" for="nota">Nota</label>
						<form:input path="nota" id="nota_numerica" type="number" step=".01" class="form-control" />
					</div>
					<div class="form-group">
						<label for="correo">Comentraio</label>
						<form:textarea path="comentario" class="form-control" />
					</div>
					<button type="button" class="btn btn-primary" id="btm_new_matricula">Crear
						Matricula</button>
				</fieldset>
			</form:form>
		</div>
